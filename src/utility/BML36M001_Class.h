...
#include "Arduino.h"
#include "Wire.h"
#include "BM_RangeSensor.h"
#include "BML36M001_ErrorCodes.h"
 ...
 public:
    ...
    */
	 ...
	 */
	 ...
	 int8_t InitSensor(uint8_t address){
		int8_t status = 0;
		...
		uint8_t byteData;
		uint16_t wordData;
		status = VL53L1_readByte(Device, 0x010F, &byteData);
		Serial.println("VL53L1X Model_ID: " + String(byteData));
		status = VL53L1_readByte(Device, 0x0110, &byteData);
		Serial.println("VL53L1X Module_Type: " + String(byteData));
		status = VL53L1_readWord(Device, 0x010F, &wordData);
...
/* VL53L1X_api.h functions */
	 ...
	 */
	int8_t VL53L1X_setI2CAddress(uint8_t new_address);
	 ...
	 */
	int8_t VL53L1X_setInterruptPolarity(uint8_t IntPol);

	/**
	 * @brief This function returns the current interrupt polarity\n
	 * 1=active high (default), 0=active low
	 */
	int8_t VL53L1X_getInterruptPolarity(uint8_t *pIntPol);
	 ...
	 */
	int8_t VL53L1X_setTimingBudgetInMs(uint16_t TimingBudgetInMs);

	/**
	 * @brief This function returns the current timing budget in ms.
	 */
	int8_t VL53L1X_getTimingBudgetInMs(uint16_t *pTimingBudgetInMs);
	 ...
	 */
	int8_t VL53L1X_setDistanceMode(uint16_t DistanceMode);

	/**
	 * @brief This function returns the current distance mode (1=short, 2=long).
	 */
	int8_t VL53L1X_getDistanceMode(uint16_t *pDistanceMode);
	 ...
	 */
	int8_t VL53L1X_setDistanceThreshold(uint16_t ThreshLow,
	 ...
	 */
	int8_t VL53L1X_getDistanceThresholdWindow(uint16_t *window);

	/**
	 * @brief This function returns the low threshold in mm
	 */
	int8_t VL53L1X_getDistanceThresholdLow(uint16_t *low);

	/**
	 * @brief This function returns the high threshold in mm
	 */
	int8_t VL53L1X_getDistanceThresholdHigh(uint16_t *high);
	 ...
	 */
	int8_t VL53L1X_StartTemperatureUpdate();
 ...
 private:
    ...
    int8_t VL53L1_writeByte(VL53L1_DEV dev, uint16_t index, uint8_t data);
    int8_t VL53L1_writeWord(VL53L1_DEV dev, uint16_t index, uint16_t data);
    int8_t VL53L1_writeDoubleWord(VL53L1_DEV dev, uint16_t index, uint32_t data);
    int8_t VL53L1_readByte(VL53L1_DEV dev, uint16_t index, uint8_t *data);
    int8_t VL53L1_readWord(VL53L1_DEV dev, uint16_t index, uint16_t *data);
    int8_t VL53L1_readDoubleWord(VL53L1_DEV dev, uint16_t index, uint32_t *data);
	...
	int8_t VL53L1_I2CWrite(uint8_t dev, uint16_t index, uint8_t *data, uint16_t number_of_bytes);
	int8_t VL53L1_I2CRead(uint8_t dev, uint16_t index, uint8_t *data, uint16_t number_of_bytes);
	int8_t VL53L1_getTickCount(uint32_t *ptick_count_ms);
	int8_t VL53L1_WaitUs(VL53L1_Dev_t *pdev, int32_t wait_us);
	int8_t VL53L1_WaitMs(VL53L1_Dev_t *pdev, int32_t wait_ms);
	
	int8_t VL53L1_WaitValueMaskEx(VL53L1_Dev_t *pdev, uint32_t timeout_ms, uint16_t index, uint8_t value, uint8_t mask, uint32_t poll_delay_ms);
